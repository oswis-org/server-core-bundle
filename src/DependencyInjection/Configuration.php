...
/**
 * Configuration definition for this bundle.
 */
class Configuration implements ConfigurationInterface
{
    ...
    private function addEmailConfig(ArrayNodeDefinition $rootNode): void
    {
    ...
    private function addAdminConfig(ArrayNodeDefinition $rootNode): void
    {
        $rootNode->children()
                 ->arrayNode('admin')
    ...
    private function addWebConfig(ArrayNodeDefinition $rootNode): void
    {
